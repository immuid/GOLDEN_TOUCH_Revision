...
public class TwoDimensionalArray {
		...
		void array2d_v1() {
			...
			for(int i=0;i<Array2D_v1.length;i++) {			// This loops around 4 times
				for(int k=0;k<Array2D_v1[i].length;k++) {
					System.out.print(Array2D_v1[i][k]+" ");  //This loops around 4*4 = 16 times 
				}
				System.out.println();
			}
		}
		...
		void array2d_v2() {
			System.out.println("Values in 2d array v2 : ");
			
			for(int i=0;i<Array2D_V2.length;i++) {
				for(int k=0;k<Array2D_V2[i].length;i++) {
